...
(function() {
  ...
  *
  * @requires SchedOutagesService The requisitions service
  * @requires growl The growl plugin for instant notifications
  *
  * @description The SynchronizeService provides a way to request a schedule synchronization asking the user how the scan process will be processed.
  */
  .factory('SynchronizeService', ['SchedOutagesService', 'growl', function(SchedOutagesService, growl) {
    return {
      /**
      ...
      synchronize: function(requisition, errorHandler) {
        ...
        */
        var doSynchronize = function(requisition, rescanExisting) {
          ...
          SchedOutagesService.synchronizeRequisition(requisition.foreignSource, rescanExisting).then(
            function() { // success
