...
@SuppressWarnings("all") public class CatSections implements java.io.Serializable {
    ...
    private java.util.List<org.opennms.reporting.availability.Section> _sectionList;
    ...
    public CatSections() {
        super();
        this._sectionList = new java.util.ArrayList<org.opennms.reporting.availability.Section>();
    }
    ...
    public void addSection(
            final org.opennms.reporting.availability.Section vSection)
     ...
     * collection
     */
    public java.util.Enumeration<org.opennms.reporting.availability.Section> enumerateSection(
    ) {
     ...
     * org.opennms.reporting.availability.Section at the given index
     */
    public org.opennms.reporting.availability.Section getSection(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.opennms.reporting.availability.Section) _sectionList.get(index);
    }
    ...
    public org.opennms.reporting.availability.Section[] getSection(
        ...
        org.opennms.reporting.availability.Section[] array = new org.opennms.reporting.availability.Section[0];
        return (org.opennms.reporting.availability.Section[]) this._sectionList.toArray(array);
    }
     ...
     */
    public java.util.List<org.opennms.reporting.availability.Section> getSectionCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<org.opennms.reporting.availability.Section> iterateSection(
    ) {
     ...
     */
    public org.opennms.reporting.availability.Section removeSectionAt(
            final int index) {
        java.lang.Object obj = this._sectionList.remove(index);
        return (org.opennms.reporting.availability.Section) obj;
    }
     ...
     */
    public void setSection(
            final org.opennms.reporting.availability.Section[] vSectionArray) {
        //-- copy array
        _sectionList.clear();
     ...
     */
    public void setSection(
            final java.util.List<org.opennms.reporting.availability.Section> vSectionList) {
        // copy vector
        this._sectionList.clear();
    ...
    public void setSectionCollection(
            final java.util.List<org.opennms.reporting.availability.Section> sectionList) {
     ...
     */
    public static org.opennms.reporting.availability.CatSections unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.opennms.reporting.availability.CatSections) Unmarshaller.unmarshal(org.opennms.reporting.availability.CatSections.class, reader);
    }
