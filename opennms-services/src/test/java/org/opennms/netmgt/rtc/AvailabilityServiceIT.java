...
public class AvailabilityServiceIT implements TemporaryDatabaseAware<MockDatabase> {
    ...
    public void categoryIsFullyAvailableWhenNoServicesArePresent() throws Exception {
        ...
        assertEquals(Long.valueOf(0), node.getNodesvccount());
        assertEquals(Long.valueOf(0), node.getNodesvcdowncount());
    }
    ...
    public void canCalculateAvailability() throws Exception {
        ...
        assertEquals(Long.valueOf(4), category.getNode(0).getNodesvccount());
        assertEquals(Long.valueOf(2), category.getNode(1).getNodesvccount());
