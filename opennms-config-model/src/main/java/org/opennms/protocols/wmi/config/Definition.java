...
@SuppressWarnings("all") public class Definition implements java.io.Serializable {
     ...
     * org.opennms.protocols.wmi.config.Range at the given index
     */
    ...
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.opennms.protocols.wmi.config.Range) _rangeList.get(index);
    }
     ...
     * @return the element removed from the collection
     */
    public org.opennms.protocols.wmi.config.Range removeRangeAt(
            final int index) {
        java.lang.Object obj = this._rangeList.remove(index);
        return (org.opennms.protocols.wmi.config.Range) obj;
    }
     ...
     */
    public void setRange(
            final org.opennms.protocols.wmi.config.Range[] vRangeArray) {
        //-- copy array
        _rangeList.clear();
     ...
     */
    public void setRange(
            final java.util.List<org.opennms.protocols.wmi.config.Range> vRangeList) {
        // copy vector
        this._rangeList.clear();
    ...
    public void setRangeCollection(
            final java.util.List<org.opennms.protocols.wmi.config.Range> rangeList) {
     ...
     * org.opennms.protocols.wmi.config.Definition
     */
