...
@SuppressWarnings("all") public class Package implements java.io.Serializable {
    ...
    private org.opennms.netmgt.config.rancid.adapter.Filter _filter;
    ...
    private java.util.List<org.opennms.netmgt.config.rancid.adapter.IncludeRange> _includeRangeList;
    ...
    private java.util.List<org.opennms.netmgt.config.rancid.adapter.ExcludeRange> _excludeRangeList;
    ...
    public Package() {
        ...
        this._includeRangeList = new java.util.ArrayList<org.opennms.netmgt.config.rancid.adapter.IncludeRange>();
        this._excludeRangeList = new java.util.ArrayList<org.opennms.netmgt.config.rancid.adapter.ExcludeRange>();
    ...
    public void addExcludeRange(
            final org.opennms.netmgt.config.rancid.adapter.ExcludeRange vExcludeRange)
    ...
    public void addIncludeRange(
            final org.opennms.netmgt.config.rancid.adapter.IncludeRange vIncludeRange)
    throws java.lang.IndexOutOfBoundsException {
     ...
     * collection
     */
    public java.util.Enumeration<org.opennms.netmgt.config.rancid.adapter.ExcludeRange> enumerateExcludeRange(
    ) {
     ...
     * collection
     */
    public java.util.Enumeration<org.opennms.netmgt.config.rancid.adapter.IncludeRange> enumerateIncludeRange(
    ) {
     ...
     * org.opennms.netmgt.config.rancid.adapter.ExcludeRange at the
     * given index
     */
    public org.opennms.netmgt.config.rancid.adapter.ExcludeRange getExcludeRange(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.opennms.netmgt.config.rancid.adapter.ExcludeRange) _excludeRangeList.get(index);
    }
    ...
    public org.opennms.netmgt.config.rancid.adapter.ExcludeRange[] getExcludeRange(
        ...
        org.opennms.netmgt.config.rancid.adapter.ExcludeRange[] array = new org.opennms.netmgt.config.rancid.adapter.ExcludeRange[0];
        return (org.opennms.netmgt.config.rancid.adapter.ExcludeRange[]) this._excludeRangeList.toArray(array);
    }
     ...
     */
    public java.util.List<org.opennms.netmgt.config.rancid.adapter.ExcludeRange> getExcludeRangeCollection(
    ) {
     ...
     */
    public org.opennms.netmgt.config.rancid.adapter.Filter getFilter(
    ) {
        return this._filter;
    }
     ...
     * given is outside the bounds of the collection
     * @return the value of the
     * org.opennms.netmgt.config.rancid.adapter.IncludeRange at the
     * given index
     */
    public org.opennms.netmgt.config.rancid.adapter.IncludeRange getIncludeRange(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        // check bounds for index
        ...
        return (org.opennms.netmgt.config.rancid.adapter.IncludeRange) _includeRangeList.get(index);
    }
    ...
    public org.opennms.netmgt.config.rancid.adapter.IncludeRange[] getIncludeRange(
        ...
        org.opennms.netmgt.config.rancid.adapter.IncludeRange[] array = new org.opennms.netmgt.config.rancid.adapter.IncludeRange[0];
        return (org.opennms.netmgt.config.rancid.adapter.IncludeRange[]) this._includeRangeList.toArray(array);
    }
     ...
     * @return a reference to the Vector backing this class
     */
    public java.util.List<org.opennms.netmgt.config.rancid.adapter.IncludeRange> getIncludeRangeCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<org.opennms.netmgt.config.rancid.adapter.ExcludeRange> iterateExcludeRange(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<org.opennms.netmgt.config.rancid.adapter.IncludeRange> iterateIncludeRange(
    ) {
     ...
     */
    public org.opennms.netmgt.config.rancid.adapter.ExcludeRange removeExcludeRangeAt(
            final int index) {
        java.lang.Object obj = this._excludeRangeList.remove(index);
        return (org.opennms.netmgt.config.rancid.adapter.ExcludeRange) obj;
    }
     ...
     * @return the element removed from the collection
     */
    public org.opennms.netmgt.config.rancid.adapter.IncludeRange removeIncludeRangeAt(
            final int index) {
        java.lang.Object obj = this._includeRangeList.remove(index);
        return (org.opennms.netmgt.config.rancid.adapter.IncludeRange) obj;
    }
     ...
     */
    public void setExcludeRange(
            final org.opennms.netmgt.config.rancid.adapter.ExcludeRange[] vExcludeRangeArray) {
        //-- copy array
     ...
     */
    public void setExcludeRange(
            final java.util.List<org.opennms.netmgt.config.rancid.adapter.ExcludeRange> vExcludeRangeList) {
        // copy vector
        this._excludeRangeList.clear();
    ...
    public void setExcludeRangeCollection(
            final java.util.List<org.opennms.netmgt.config.rancid.adapter.ExcludeRange> excludeRangeList) {
    ...
    public void setFilter(
            final org.opennms.netmgt.config.rancid.adapter.Filter filter) {
        this._filter = filter;
    }
     ...
     */
    public void setIncludeRange(
            final org.opennms.netmgt.config.rancid.adapter.IncludeRange[] vIncludeRangeArray) {
        //-- copy array
     ...
     */
    public void setIncludeRange(
            final java.util.List<org.opennms.netmgt.config.rancid.adapter.IncludeRange> vIncludeRangeList) {
        // copy vector
        this._includeRangeList.clear();
    ...
    public void setIncludeRangeCollection(
            final java.util.List<org.opennms.netmgt.config.rancid.adapter.IncludeRange> includeRangeList) {
     ...
     * org.opennms.netmgt.config.rancid.adapter.Package
     */
    public static org.opennms.netmgt.config.rancid.adapter.Package unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.opennms.netmgt.config.rancid.adapter.Package) Unmarshaller.unmarshal(org.opennms.netmgt.config.rancid.adapter.Package.class, reader);
    }
