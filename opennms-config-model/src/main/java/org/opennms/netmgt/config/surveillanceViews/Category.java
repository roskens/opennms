 ...
 *  related directly to monitored services. I have separated out
 * this element so that it can be refereneced by other entities
...
@SuppressWarnings("all") public class Category implements java.io.Serializable {
     ...
     * org.opennms.netmgt.config.surveillanceViews.Category
     */
    public static org.opennms.netmgt.config.surveillanceViews.Category unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.opennms.netmgt.config.surveillanceViews.Category) Unmarshaller.unmarshal(org.opennms.netmgt.config.surveillanceViews.Category.class, reader);
    }
