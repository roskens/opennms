...
@SuppressWarnings("all") public class Filter implements java.io.Serializable {
     ...
     * org.opennms.netmgt.config.snmpinterfacepoller.Filter
     */
    public static org.opennms.netmgt.config.snmpinterfacepoller.Filter unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.opennms.netmgt.config.snmpinterfacepoller.Filter) Unmarshaller.unmarshal(org.opennms.netmgt.config.snmpinterfacepoller.Filter.class, reader);
    }
