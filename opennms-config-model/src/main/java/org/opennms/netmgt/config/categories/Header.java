...
@SuppressWarnings("all") public class Header implements java.io.Serializable {
     ...
     * org.opennms.netmgt.config.categories.Header
     */
    public static org.opennms.netmgt.config.categories.Header unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.opennms.netmgt.config.categories.Header) Unmarshaller.unmarshal(org.opennms.netmgt.config.categories.Header.class, reader);
    }
