...
public class IncludeRange implements java.io.Serializable {
     ...
     * org.opennms.netmgt.config.rancid.adapter.IncludeRange
     */
    public static org.opennms.netmgt.config.rancid.adapter.IncludeRange unmarshal(
            final java.io.Reader reader)
            throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.opennms.netmgt.config.rancid.adapter.IncludeRange) Unmarshaller.unmarshal(org.opennms.netmgt.config.rancid.adapter.IncludeRange.class, reader);
    }
