...
/**
 * A range of addresses to be excluded from
 *  polling.
 *
...
@SuppressWarnings("all") public class ExcludeRange implements java.io.Serializable {
     ...
     */
    public static org.opennms.netmgt.config.discovery.ExcludeRange unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.opennms.netmgt.config.discovery.ExcludeRange) Unmarshaller.unmarshal(org.opennms.netmgt.config.discovery.ExcludeRange.class, reader);
    }
