...
public class EventdConfiguration implements java.io.Serializable {
    ...
    public boolean equals(
        ...
        if (obj instanceof EventdConfiguration) {
            ...
            if (this._socketSoTimeoutRequired != null) {
                if (temp._socketSoTimeoutRequired == null) {
                    return false;
            ...
            if (this._socketSoTimeoutPeriod != null) {
                if (temp._socketSoTimeoutPeriod == null) {
                    return false;
            ...
            if (this._logEventSummaries != null) {
                if (temp._logEventSummaries == null) {
                    return false;
