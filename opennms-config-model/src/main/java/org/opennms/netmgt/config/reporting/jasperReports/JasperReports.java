...
@SuppressWarnings("all") public class JasperReports implements java.io.Serializable {
     ...
     * org.opennms.netmgt.config.reporting.jasperReports.Report at
     * the given index
     */
    ...
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.opennms.netmgt.config.reporting.jasperReports.Report) _reportList.get(index);
    }
     ...
     */
    public org.opennms.netmgt.config.reporting.jasperReports.Report removeReportAt(
            final int index) {
        java.lang.Object obj = this._reportList.remove(index);
        return (org.opennms.netmgt.config.reporting.jasperReports.Report) obj;
    }
     ...
     */
    public void setReport(
            final org.opennms.netmgt.config.reporting.jasperReports.Report[] vReportArray) {
        //-- copy array
        _reportList.clear();
     ...
     */
    public void setReport(
            final java.util.List<org.opennms.netmgt.config.reporting.jasperReports.Report> vReportList) {
        // copy vector
        this._reportList.clear();
    ...
    public void setReportCollection(
            final java.util.List<org.opennms.netmgt.config.reporting.jasperReports.Report> reportList) {
     ...
     * org.opennms.netmgt.config.reporting.jasperReports.JasperReports
     */
