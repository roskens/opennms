...
public class StringParm implements java.io.Serializable {
     ...
     * field used. Allows the webUI to use pre-filled drop-down
     * boxes (reportCategorySelector) or freeText
     *
     ...
     * Allows the webUI to use pre-filled drop-down boxes
     * (reportCategorySelector) or freeText
     *
     ...
     * org.opennms.netmgt.config.reporting.opennms.StringParm
     */
