...
@SuppressWarnings("all") public class Header implements java.io.Serializable {
     ...
     * org.opennms.netmgt.config.groups.Header
     */
    public static org.opennms.netmgt.config.groups.Header unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.opennms.netmgt.config.groups.Header) Unmarshaller.unmarshal(org.opennms.netmgt.config.groups.Header.class, reader);
    }
