...
/**
 * An offset period used as a base to determine a real date when
 * running the report.
 *
...
@SuppressWarnings("all") public class DateParm implements java.io.Serializable {
    ...
    public void setDefaultTime(
            final org.opennms.netmgt.config.reporting.opennms.DefaultTime defaultTime) {
     ...
     * org.opennms.netmgt.config.reporting.opennms.DateParm
     */
