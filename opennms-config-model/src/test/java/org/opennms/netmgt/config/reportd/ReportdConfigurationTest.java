...
public class ReportdConfigurationTest extends XmlTest<ReportdConfiguration> {

    public ReportdConfigurationTest(final ReportdConfiguration sampleObject, final String sampleXml, final String schemaFile) {
