...
public class OutageConfigurationTest extends XmlTestNoCastor<OutageConfiguration> {

    public OutageConfigurationTest(final OutageConfiguration sampleObject, final String sampleXml, final String schemaFile) {
