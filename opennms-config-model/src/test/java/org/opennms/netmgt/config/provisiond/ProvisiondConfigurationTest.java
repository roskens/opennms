...
public class ProvisiondConfigurationTest extends XmlTest<ProvisiondConfiguration> {

    public ProvisiondConfigurationTest(final ProvisiondConfiguration sampleObject, final String sampleXml, final String schemaFile) {
