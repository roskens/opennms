...
public class RTCConfigurationTest extends XmlTest<RTCConfiguration> {

    public RTCConfigurationTest(final RTCConfiguration sampleObject, final String sampleXml, final String schemaFile) {
