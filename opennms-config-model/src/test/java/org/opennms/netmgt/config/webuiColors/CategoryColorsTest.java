...
public class CategoryColorsTest extends XmlTestNoCastor<CategoryColors> {

    public CategoryColorsTest(final CategoryColors sampleObject, final String sampleXml, final String schemaFile) {
