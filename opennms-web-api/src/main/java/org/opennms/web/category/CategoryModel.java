...
public class CategoryModel extends Object {
     ...
     */
    public static synchronized CategoryModel getInstance() throws DataAccessException, IOException {
     ...
     */
    private CategoryModel() throws DataAccessException, IOException {
