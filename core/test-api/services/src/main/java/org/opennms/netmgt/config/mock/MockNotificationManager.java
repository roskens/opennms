...
public class MockNotificationManager extends NotificationManager {
    ...
    public MockNotificationManager(NotifdConfigManager configManager, DataSource db, String mgrString) throws DataAccessException {
     ...
     */
    @Override
    public void update() throws IOException, DataAccessException {
    }
