...
public class SimpleNamespacesFilter extends XMLFilterImpl {
    ...
    public SimpleNamespacesFilter(final List<String> namespaceUris, final Boolean addNamespace) {
        super();

        LOG.trace("SimpleNamespaceFilter initalized with namespaces {} ({})", namespaceUris, addNamespace);
        if (addNamespace) {
    ...
    public void startElement(final String uri, final String localName, final String qName, final Attributes attributes) throws SAXException {
        if (m_addNamespace) {
            LOG.trace("start: uri = {}, new uri = {}, localName = {}, qName = {}, attributes = {}", uri, m_namespaceUris, localName, qName, attributes);
            ...
            if (type != null) {
                ...
                super.startElement(m_namespaceUris.get(0), localName, qName, att);
            } else {
                super.startElement(m_namespaceUris.get(0), localName, qName, attributes);
            }
        }  else {
    ...
    public void endElement(final String uri, final String localName, final String qName) throws SAXException {
        if(m_addNamespace) {
            LOG.trace("end:   uri = {}, new uri = {}, localName = {}, qName = {}", uri, m_namespaceUris.get(0), localName, qName);
            super.endElement(m_namespaceUris.get(0), localName, qName);
        } else {
    ...
    private void startControlledPrefixMapping() throws SAXException {
        ...
        if (m_addNamespace && !m_addedNamespace) {
            ...
            super.startPrefixMapping("".intern(), m_namespaceUris.get(0));
    ...
    public String toString() {
        return "SimpleNamespaceFilter[namespaceUris=" + m_namespaceUris + ",addNamespace=" + m_addNamespace + "]";
    }
}
