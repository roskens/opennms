...
@SuppressWarnings("all") public class CalendarTable implements java.io.Serializable {
    ...
    private org.opennms.report.availability.DaysOfWeek _daysOfWeek;

    /**
     * Field _weekList.
     */
    @XmlElement(name="week")
    private java.util.List<org.opennms.report.availability.Week> _weekList;
    ...
    public CalendarTable() {
        super();
        this._weekList = new java.util.ArrayList<org.opennms.report.availability.Week>();
    }
     ...
     */
    public void addWeek(
            final org.opennms.report.availability.Week vWeek)
     ...
     * collection
     */
    public java.util.Enumeration<org.opennms.report.availability.Week> enumerateWeek(
    ) {
     ...
     */
    public org.opennms.report.availability.DaysOfWeek getDaysOfWeek(
    ) {
     ...
     * org.opennms.report.availability.Week at the given index
     */
    public org.opennms.report.availability.Week getWeek(
            final int index)
    throws java.lang.IndexOutOfBoundsException {
        ...
        return (org.opennms.report.availability.Week) _weekList.get(index);
    }
    ...
    public org.opennms.report.availability.Week[] getWeek(
        ...
        org.opennms.report.availability.Week[] array = new org.opennms.report.availability.Week[0];
        return (org.opennms.report.availability.Week[]) this._weekList.toArray(array);
    }
     ...
     */
    public java.util.List<org.opennms.report.availability.Week> getWeekCollection(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<org.opennms.report.availability.Week> iterateWeek(
    ) {
     ...
     */
    public org.opennms.report.availability.Week removeWeekAt(
            final int index) {
        java.lang.Object obj = this._weekList.remove(index);
        return (org.opennms.report.availability.Week) obj;
    }
    ...
    public void setDaysOfWeek(
            final org.opennms.report.availability.DaysOfWeek daysOfWeek) {
     ...
     */
    public void setWeek(
            final org.opennms.report.availability.Week[] vWeekArray) {
        //-- copy array
        _weekList.clear();
     ...
     */
    public void setWeek(
            final java.util.List<org.opennms.report.availability.Week> vWeekList) {
        // copy vector
        this._weekList.clear();
    ...
    public void setWeekCollection(
            final java.util.List<org.opennms.report.availability.Week> weekList) {
     ...
     * org.opennms.report.availability.CalendarTable
     */
    public static org.opennms.report.availability.CalendarTable unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.opennms.report.availability.CalendarTable) Unmarshaller.unmarshal(org.opennms.report.availability.CalendarTable.class, reader);
    }
