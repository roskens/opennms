...
@SuppressWarnings("all") public class Section implements java.io.Serializable {
    ...
    private org.opennms.report.availability.ClassicTable _classicTable;

    /**
     * Field _calendarTable.
     */
    @XmlElement(name="calendarTable")
    private org.opennms.report.availability.CalendarTable _calendarTable;
     ...
     */
    public org.opennms.report.availability.CalendarTable getCalendarTable(
    ) {
     ...
     */
    public org.opennms.report.availability.ClassicTable getClassicTable(
    ) {
    ...
    public void setCalendarTable(
            final org.opennms.report.availability.CalendarTable calendarTable) {
    ...
    public void setClassicTable(
            final org.opennms.report.availability.ClassicTable classicTable) {
     ...
     * org.opennms.report.availability.Section
     */
    public static org.opennms.report.availability.Section unmarshal(
            final java.io.Reader reader)
    throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException {
        return (org.opennms.report.availability.Section) Unmarshaller.unmarshal(org.opennms.report.availability.Section.class, reader);
    }
