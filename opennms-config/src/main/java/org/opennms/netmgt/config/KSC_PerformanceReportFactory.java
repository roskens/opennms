...
public class KSC_PerformanceReportFactory {
     ...
     * @throws org.springframework.dao.DataAccessException if any.
     */
    public synchronized void saveCurrent() throws DataAccessException, FileNotFoundException, IOException {
        assertInitialized();

        sortByTitle();

        JaxbUtils.marshalViaString(m_config, s_configFile);
     ...
     * @throws org.springframework.dao.DataAccessException if any.
     */
    public void deleteReportAndSave(int index) throws ArrayIndexOutOfBoundsException, IOException, FileNotFoundException, DataAccessException {
